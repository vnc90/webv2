...
function MetaMaskButton() {
  ...
  const VNCToolsAddress = '0xa92D7f42A1B712885D79cdcCc7A5C5dC3Bc48f44'
    ...
    {walletAddress ? (
      <div className={styles.connected}>
        <div className={styles.linenear}>  
          ...
          <button onClick={disconnectFromMetaMask} className='bg-gray-300 p-1 text-xs hover:bg-gray-100'>Disconnect</button>
        </div>
